  ...
  return (
    <div className="mt-2 flex flex-col gap-3 ">
      <UICheckbox.Root
        ...
        disabled={disabled}
      >
        <div className="h-7 w-7 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-600 transition-all">
